...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Utility/ExtraControl.inputactions".
/// </summary>
/// <remarks>
...
public partial class @ExtraControl: IInputActionCollection2, IDisposable
{
    ...
    ~@ExtraControl()
    {
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ExtraControl.UI.Disable() has not been called.");
    }
